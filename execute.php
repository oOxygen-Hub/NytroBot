<?php
  ...
  if($querydata == "ModificaMessaggio"){
   ...
   $tastierainline = '[{"text":"Testo","url":"http://ooxygen.tech"},{"text":"Inline","switch_inline_query":"Ciao!"}],[{"text":"Testo","callback_data":"StampaMessaggio"},{"text":"Nytro","callback_data":"ModificaMessaggio"}]';
